<script>
    ...
    const fetchData = async () => {
        ...
        // Modify the data conversion step to include geometry (coordinates)
        // Modify the data conversion step to include geometry (coordinates)
        data = json.features.map(feature => {
            ...
            switch (feature.geometry.type) {
                case 'Point':
                    ...
                    break;
                case 'Polygon':
                    // A polygon has a nested array structure. 
                    // Here we take the first set of coordinates from the first ring
            ...
            return {
                ...
                coordinates: coordinates  // Include geometry data
